        ...
        <div className="flex-[1.3] flex flex-col items-start  justify-items-center mt-10 mobile:items-center">
          ...
          <div className="flex flex-col place-self-start">
            ...
            <div className="colors flex mt-7 text-2xl">
              Colors
              <div className="colorSelect bg-red-600 hover:border-[#8a4af3]"></div>
              <div className="colorSelect bg-blue-600 hover:border-[#8a4af3]"></div>
              <div className="colorSelect bg-yellow-400 hover:border-[#8a4af3]"></div>
            </div>
          ...
          <Link to="/cart">
          <button className="btn text-white bg-[#8a4af3] rounded-md shadow-md mt-[30px] mb-[10px] p-3">
            Add to Cart
            </button>
            </Link>
        </div>
